	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		function addTableClass(element){
			element.addClass('fp-table').wrapInner('<div class="fp-tableCell" css="height:' + getTableHeight(element) + 'px;" />');
		}
		...
		*/
		function setBodyClass(text){
			//changing slash for dash to make it a valid CSS css
		...
		*/
		function support3d() {
			...
			// Add it to the body to get the computed css.
